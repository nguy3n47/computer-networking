...
MENU:
			cout<<"         MENU"<<endl<<"1. Dang ky tai khoan"<<endl;
...
TaoTK:
			...
			{
				cout<<"User bat buoc la 1 dia chi gmail\n"<<endl;
				goto TaoTK;
			}
			client.Send(&lenUser,sizeof(int),0);
			client.Send((UserName),lenUser,0);
...
DSTV:
					...
					if(kqtv == 3)
					{
						...
						char* Sove = new char[10];
						char* Ngay = new char[5];
						cout << "<TenTinhThanh> <SoVe> ";
						cin.getline(str, 50);
						cin.clear();
						char* token = strtok(str, " ");
						Tentinhthanh = token;
						//cout << Tentinhthanh << endl;
						/*cout<<"<TenTinhThanh>: ";
						cin>>Tentinhthanh;*/
						int len_ten = strlen(Tentinhthanh);
						/*cout<<"<Sove>: ";
